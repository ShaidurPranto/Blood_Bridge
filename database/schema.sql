...
-- ----------------------------
ALTER TABLE "BB"."BLOOD_BANK_INFO" ADD CONSTRAINT "SYS_C007556" CHECK ("BLOODGROUP" IS NOT NULL) NOT DEFERRABLE INITIALLY IMMEDIATE NORELY VALIDATE;
...
ALTER TABLE "BB"."DONOR_BLOOD_INFO" ADD CONSTRAINT "SYS_C007510" CHECK ("BLOODGROUP" IS NOT NULL) NOT DEFERRABLE INITIALLY IMMEDIATE NORELY VALIDATE;
